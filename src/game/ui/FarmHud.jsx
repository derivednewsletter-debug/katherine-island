...
const RESOURCE_ICON_MAP = { berry: 'berry', shell: 'shell', stone: 'stone', wood: 'wood', flower: 'flower', fruit: 'fruit', herb: 'herb', coin: 'coin' };
...
export default function FarmHud() {
  ...
  return (
    <>
      ...
      >
        <SvgIcon name="farm" size={16} /> Farm
        {raining && <span style={{ marginLeft: 6, fontSize: 13 }}><SvgIcon name="rain" size={14} /></span>}
        {wiltCount > 0 && (
          <span
            style={{
              marginLeft: 6,
          ...
          >
            <SvgIcon name="warning" size={10} /> {wiltCount}
          </span>
        )}
        {readyCount > 0 && (
          <span
      ...
      {farmOpen && (
        ...
        >
          ...
          {raining && (
            ...
            >
              <SvgIcon name="rain" size={16} /> Rain shower — crops are growing at <b>2× speed</b> while it lasts
            </div>
          )}
            ...
            return (
              ...
              >
                 <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                   <SvgIcon name={CROP_ICON_MAP[crop.cropId] || 'farm'} size={20} />
                   ...
                   >
                     <SvgIcon name="arrowUp" size={12} /> Fly
                   </button>
                </div>
                ...
                {ready && (
                 ...
                 {Object.entries(def.reward).map(([resource, amount]) => (
                      ...
                      >
                        <SvgIcon name={RESOURCE_ICON_MAP[resource] || 'berry'} size={10} />
                        +{amount} — click to harvest
                      </span>
                    ))}
                  </div>
                )}
